package com.xinshiyun.smarttvonline.widget.focus;
...
@SuppressLint("NewApi")
public class FocusMenuView extends RelativeLayout {
    ...
    public FocusMenuView(Context context) {
        super(context);
        init(context, null);
    }

    public FocusMenuView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public FocusMenuView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    protected void init(Context context, AttributeSet attrs) {
        ...
        if (mDownDrawable == null) {
            mDownDrawable = getResources().getDrawable(R.drawable.button_focus);
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        } /*else if (!hasFocus() && mDownDrawable != null && isPressDown) {
            Log.e("onDraw","-------- isPressDown");
            super.getDrawingRect(mRect);
            mBound.set(-leftShadowWidth + mRect.left, -topShadowWidth + mRect.top, rightShadowWidth + mRect.right, bottomShadowWidth + mRect.bottom);
            mDownDrawable.setBounds(mBound);
            canvas.save();
